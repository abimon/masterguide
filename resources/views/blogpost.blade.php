                ...
                <div class="col-lg-9 blog-post-single">
					...
					<div class="blog-author">
						...
						<div class="author-desc">
							<img src="{{asset('storage/images/author.jpg')}}" alt="about author">
					...
					<div class="blog-comments">
						...
						<div id="comment-blog">
							<ul class="comment-list">
								<li class="comment">
									<div class="avatar"><img alt="" src="{{asset('storage/images/avatar-01.jpg')}}" class="avatar"></div>
								...
								<li class="comment">
									<div class="avatar"><img alt="" src="{{asset('storage/images/avatar-02.jpg')}}" class="avatar"></div>
									<div class="comment-container">
										<h5 class="comment-author"><a href="#">John Smith</a></h5>
										<div class="comment-meta">
											<a href="#" class="comment-date link-style1">February 22, 2015</a>
									...
									<ul class="children">
										<li class="comment">
											<div class="avatar"><img alt="" src="{{asset('storage/images/avatar-03.jpg')}}" class="avatar"></div>
											<div class="comment-container">
						...
						<div class="comment-form-main">
							<form action="#">
								<div class="row">
									...
									<div class="col-md-4">
										<div class="form-group">
											<input class="form-control" name="phone" placeholder="Phone Number" id="contact" type="text">
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
